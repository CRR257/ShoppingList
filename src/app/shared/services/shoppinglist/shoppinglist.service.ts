...
// https://stackoverflow.com/questions/48966130/firebase-function-to-return-json
  ...
  async deleteAllItemsCollection(path) {
    const ref = this.userCollection.doc(path).ref.get()
